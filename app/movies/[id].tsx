...
const MovieDetail = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      ...
      <TouchableOpacity onPress={router.back} className='absolute bottom-5 left-0 right-0 mx-8 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50'>
        <Image
          source={icons.arrow}
